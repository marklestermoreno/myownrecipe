                    ...
                    <Box className='download'>
                      ...
                      <motion.button
                        ...
                        onClick={() => {
                          ...
                          const doc = new jsPDF({
                            ...
                            format:
                              food.steps.length <= 3 ?
                                [10, 10]
                                :
                                food.steps.length > 3 && food.steps.length <= 5 ?
                                  [10, 12.5]
                                  :
                                  food.steps.length >= 6 && food.steps.length <= 10 ?
                                    [10, 17.5]
                                    :
                                    food.steps.length >= 11 && food.steps.length <= 15 ?
                                      [10, 23.5]
                                      :
                                      food.steps.length >= 16 && food.steps.length <= 20 ?
                                        [10, 29.5]
                                        :
                                        [10, 35.5]
                          ...
                          doc.setTextColor(59, 64, 67);
                          doc.setFontSize(20)
                          doc.setFont("helvetica", "bold");
                          doc.text(food.foodName, 1, 1);
                          doc.setFontSize(15)
                          doc.setFont("helvetica", "normal");
                          doc.text("by " + food.foodAuthor, 1, 1.4);
                          doc.setFontSize(12)

                          // Difficulty
                          doc.setTextColor(1, 147, 124);
                          doc.text("Difficulty:", 1, 1.9);
                          doc.setFont("helvetica", "thin");
                          doc.setTextColor(59, 64, 67);
                          doc.text(food.difficulty, 1.7, 1.9);
                          ...
                          doc.setFont("helvetica", "thin");
                          doc.setTextColor(59, 64, 67);
                          doc.text(food.time + ' Minutes', 1.45, 2.2);

                          // Rating
                          doc.setTextColor(1, 147, 124);
                          doc.text("Rating:", 1, 2.5);
                          doc.setFont("helvetica", "thin");
                          doc.setTextColor(59, 64, 67);
                          doc.text((food.rating / food.user).toLocaleString(undefined, { maximumFractionDigits: 2, minimumFractionDigits: 2 }) + " (" + food.user + " User Rated)", 1.55, 2.5);

                          // Ingredients
                          doc.setFontSize(15)
                          doc.setTextColor(1, 147, 124);
                          doc.setFont("helvetica", "bold");
                          doc.text("Ingredients", 1, 3);
                          ...
                          doc.text("Steps", 1,
                            food.ingredients.length <= 3 ?
                              4.5
                              :
                              food.ingredients.length > 3 && food.ingredients.length <= 5 ?
                                5.5
                                :
                                food.ingredients.length > 6 && food.ingredients.length <= 10 ?
                                  6.5
                                  :
                                  food.ingredients.length > 11 && food.ingredients.length <= 15 ?
                                    7.5
                                    :
                                    food.ingredients.length > 16 && food.ingredients.length <= 20 ?
                                      8.5
                                      :
                                      8.5
                          );
                          ...
                          doc.save(`${food.foodName} - ${food.foodAuthor}`);
